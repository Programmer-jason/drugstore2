<?php session_start();
  ...
  if ($err) {
    ...
    $sql_insert = "INSERT INTO `paymentdetails`(`paymentId`, `refId`, `checkoutId`, `name`, `contact`, `price`, `paymentStatus`, `dateRecieved`, `paymentType`, `paymentAction`) 
                  VALUES (null,'$get_reference','$checkout_id', '$get_checkout_name', '', '$total_amount', '$get_checkout_status', '', '$get_paymentMethod', 'not_recieve')";
